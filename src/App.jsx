...
function App() {
  ...
  return (
    <div className="min-h-screen max-w-[1280px] mx-auto flex flex-col text-zinc font-display">
      <Header clickedCardIds={clickedCardIds} onChange={changeCardsNumber} />
      <CardsContainer cardsList={cardsList} handleCardClick={handleCardClick} />
      <footer className="mt-auto self-center p-[1em] pt-[clamp(3em,5vw,5em)]">
